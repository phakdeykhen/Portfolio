        ...
        <div className="contact-layout">
          ...
          <div className="contact-info-cards">
            ...
            <div className="info-card interactive-hover">
              ...
              <div className="card-details">
                <span className="details-label">{t('contact.third_line')}</span>
                <a href="tel:093524860" className="details-value">093 524 860</a>
              </div>
              <button
                onClick={() => handleCopy('093 524 860', 'phone3')}
                className={`copy-btn ${copiedType === 'phone3' ? 'copied' : ''}`}
                title="Copy to clipboard"
              >
                {copiedType === 'phone3' ? copiedText : copyText}
              </button>
            </div>
