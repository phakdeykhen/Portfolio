...
// Adapted to support orbiting React nodes / text labels (not only images).
...
export default function OrbitImages({
  ...
  // Text labels take priority over images when provided.
  const items = labels
    ? labels.map((label) => (
        <span key={label} className="orbit-chip">{label}</span>
      ))
