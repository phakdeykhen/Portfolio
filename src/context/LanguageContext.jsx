...
const projectTranslations = {
  ...
  '16.title': 'ប្រព័ន្ធគ្រប់គ្រងវត្តមាន និងច្បាប់ឈប់សម្រាក (ScanMe)',
  '16.desc': 'ប្រព័ន្ធគ្រប់គ្រងវត្តមាន និងច្បាប់ឈប់សម្រាកបុគ្គលិកពេញលេញ (វិបសាយ និងកម្មវិធីទូរស័ព្ទ) ដែលមានមុខងារស្កេន QR កត់ត្រាវត្តមាន គ្រប់គ្រងច្បាប់ឈប់សម្រាក ការអនុម័តសំណើ តាមដានថែមម៉ោង និងការគ្រប់គ្រងក្រុមការងារ។'
};
